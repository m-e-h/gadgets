<?php
/**
 * Gadgets_And_Toggles class.  Extends the Gadgets_And_Posts class to format the gadget posts into 
 * a group of toggles.
 *
 * @package    Gadgets
 * @subpackage Includes
 ...
 */
class Gadgets_And_Toggles extends Gadgets_And_Posts {
	...
	public function set_markup( $gadgets ) {
		...
		if ( !empty( $gadgets ) ) {
			...
			$output .= '<div class="gadgets gadgets-toggle">';
